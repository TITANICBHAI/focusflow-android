  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.background }]} edges={['top']}>
      ...
      {loading ? (
        ...
        <ScrollView
          style={styles.scroll}
          contentContainerStyle={[styles.content, { paddingBottom: 60 + insets.bottom + 20 }]}
              ...
              {dayStats.map((d, i) => {
                ...
                return (
                  <View key={d.date} style={styles.barCol}>
                    ...
                    <Text style={[
                      styles.barDay,
                      { color: isToday ? COLORS.primary : theme.muted, fontWeight: isToday ? '700' : '500' },
                    ]}>
                      {d.day}
                    </Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  refreshText: { fontSize: FONT.sm, fontWeight: '600' },
});
